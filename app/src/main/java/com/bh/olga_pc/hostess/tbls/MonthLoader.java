...
public class MonthLoader implements TableViewLoader {
    ...
    @Override
    public List<? extends Event> onLoad(int periodIndex){
    ...
    public interface MonthChangeListener {
         ...
         */
        List<? extends Event> onMonthChange(int newYear, int newMonth);
    }
}
